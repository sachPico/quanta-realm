...
//     List<Path> pathToBeDisplayed = new List<Path>();
...
//         if (pathToBeDisplayed != null)
//         {
//             if (pathToBeDisplayed.Count > 0)
//             {
//                 SceneViewUtility.DrawPaths(pathToBeDisplayed);
//             }
//         }
...
//         pathToBeDisplayed = null;
//         bezierToBeDisplayed = null;
...
//                 case EnemyType.PK004:
//                     sep.spawns[j].enemy = EnemyType.PK004;
//                     if (sep.spawns[j].enemyProperty == null)
//                     {
//                         sep.spawns[j].enemyProperty = new ZweiProperty();
//                     }
//                     else
//                     {
//                         if (sep.spawns[j].enemyProperty.GetType() != typeof(ZweiProperty))
//                         {
//                             sep.spawns[j].enemyProperty = new ZweiProperty();
//                         }
//                     }

//                     ZweiProperty zp = (ZweiProperty)sep.spawns[j].enemyProperty;

//                     zp.maxSpeed = EditorGUILayout.FloatField("Maximum speed", zp.maxSpeed);
//                     zp.maxSteeringForce = EditorGUILayout.FloatField("Maximum steering force", zp.maxSteeringForce);
...
//                         {
//                             //Debug.Log("A");
//                             zp.paths.Add(new Path(Vector3.zero, Vector3.one, 8f));
//                         }
//                         else
//                         {
//                             //Debug.Log("B"+zp.paths.Count);
//                             for (int i = 0; i < zp.paths.Count; i++)
//                             {
//                                 if (i == 0)
//                                 {
//                                     //Debug.Log("D");
//                                     zp.paths[i].startPoint = sep.spawns[j].spawnLocation;
//                                 }
//                                 else
//                                 {
//                                     zp.paths[i].startPoint = EditorGUILayout.Vector3Field("Start point " + i, zp.paths[i].startPoint);
//                                 }

//                                 zp.paths[i].endPoint = EditorGUILayout.Vector3Field("End point " + i, zp.paths[i].endPoint);
//                                 zp.paths[i].radius = EditorGUILayout.FloatField("Radius", zp.paths[i].radius);
//                             }
//                         }
//                     }
//                     else
//                     {
//                         //Debug.Log("C");
//                         zp.paths = new List<Path>();
//                         zp.paths.Add(new Path(Vector3.zero, Vector3.one, 8f));
//                     }

//                     if (GUILayout.Button("Add new path"))
//                     {
//                         zp.paths.Add(new Path(zp.paths[zp.paths.Count - 1].startPoint, zp.paths[zp.paths.Count - 1].endPoint, zp.paths[zp.paths.Count - 1].radius));
//                     }

//                     if (GUILayout.Button("Remove last path"))
//                     {
//                         zp.paths.RemoveAt(zp.paths.Count - 1);
//                     }

//                     if (GUILayout.Button("Reset path"))
//                     {
//                         zp.paths.Clear();
//                         zp.paths.Add(new Path(sep.spawns[j].spawnLocation, sep.spawns[j].spawnLocation + Vector3.left, 8f));
//                     }

//                     pathToBeDisplayed = zp.paths;
